...
import { builder, client } from "@/sanity/client";
import CodeBlockRenderer from "@/_components/CodeBlockRenderer";
import ReadingProgress from "@/_components/ReadingProgress";
import TableOfContentsPanel from "@/_components/TableOfContentsPanel";
...
import BlogActions from "@/_components/blogs-page/BlogActions";
...
const portableTextComponents: PortableTextComponents = {
  types: {
    ...
    tableRich: ({ value }: { value: { rows: { cells: { content: any }[] }[] } }) => (
