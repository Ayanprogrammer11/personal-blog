...
export default function DeleteCommentDialog({
  ...
  const hasReplies = replies && replies.some((r) => r.parentId === comment._id);
  const replyCount =
    replies?.filter((r) => r.parentId === comment._id).length ?? 0;
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-700">
                    Deleting this comment will also delete all {replyCount}{" "}
