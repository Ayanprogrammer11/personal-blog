...
export function AvatarUpload({ initialAvatar }: { initialAvatar?: string }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-0 bg-black bg-opacity-40 rounded-2xl flex items-center justify-center transition-opacity ${
